...
const CafeClients = () => {
    ...
    let { cafeWarehouseId } = useWarehouseStore();
    ...
    return (
        <Box minH="100vh" p={6}>
            ...
            <Flex mb={6} justify="space-between" align="center">
                <Box>
                    <Heading size="xl">Klienlar</Heading>
                    <Text mt={1}>
                        Jami: {pagination?.total_count || 0} ta klient
                    </Text>
                </Box>
                <Button
                            ...
                            {partners.length > 0 ?
                                (
                                    ...
                                    <VStack py={12} spacing={4}>
                                        <Text color="gray.500" fontSize="lg">Hozircha klientlar yo'q</Text>
                                        <Button colorScheme="blue" variant="link" onClick={onAddOpen}>
                                            Birinchi klient qo'shish
                                        </Button>
                                    </VStack>
                                )}
                        </Box>
            ...
            <Modal isOpen={isAddOpen} onClose={onAddClose} size="md">
                ...
                <ModalContent>
                    <form onSubmit={handleAddPartner}>
                        <ModalHeader>Yangi klient</ModalHeader>
                        <ModalCloseButton />
                        <ModalBody>
                            <Stack spacing={4}>
            ...
            <Modal isOpen={isEditOpen} onClose={onEditClose} size="md">
                ...
                <ModalContent>
                    <form onSubmit={handleEditPartner}>
                        <ModalHeader>Klientni tahrirlash</ModalHeader>
                        <ModalCloseButton />
                        <ModalBody>
                            <Stack spacing={4}>
                                <FormControl isRequired>
            ...
            <Modal isOpen={isDeleteOpen} onClose={onDeleteClose} size="md">
                <ModalOverlay />
                <ModalContent>
                    <ModalHeader>Klientni o'chirish</ModalHeader>
                    <ModalCloseButton />
                    <ModalBody>
                        <Text>
                            <strong>{selectedPartner?.name}</strong> klientini o'chirishni tasdiqlaysizmi?
            ...
            <Modal isOpen={isPaymentOpen} onClose={onPaymentClose} size="md">
                ...
                <ModalContent>
                    <form onSubmit={handlePayment}>
                        <ModalHeader>
                            To'lovni qabul qilish - {selectedPartner?.name}
                        </ModalHeader>
                        <ModalCloseButton />
                        <ModalBody>
