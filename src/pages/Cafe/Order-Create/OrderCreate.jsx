...
export default function OrderCreate() {
    ...
    const createOrder = async () => {
        ...
        try {
            ...
            setPaymentData(response.data?.payment || response.payment);
        ...
        <Box bg={bgPage} minH="100vh" p={{ base: 4, md: 6 }}>
            ...
            <Box mb={5}>
                ...
                <ButtonGroup isAttached variant="outline" size="sm">
                    <Button
                        colorScheme="blue"
                        variant={orderType === "cash" ? "solid" : "outline"}
                        onClick={() => setOrderType("success")}
                    >
                        Chiqim
                    </Button>
                    <Button
                        colorScheme="orange"
                        variant={orderType === "debt" ? "solid" : "outline"}
            ...
            {orderItems.length > 0 && (
                ...
                >
                    ...
                    <HStack spacing={3} flexWrap="wrap">
                        <Badge
                            colorScheme={orderType === "cash" ? "blue" : "orange"}
                            fontSize="sm"
                            px={3}
                            py={1}
                            borderRadius="md"
                        >
                            {orderType === "cash" ? "Naqd" : "Nasiya"}
                        </Badge>
                        <Badge
                            colorScheme="gray"
                            fontSize="sm"
            ...
            {/* MAHSULOTLAR MODAL - Now a separate component */}
            <ProductModal
