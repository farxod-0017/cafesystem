...
// DETAIL MODAL
// ══════════════════════════════════
export default function ReturnModal({ isOpen, onClose, order, returning, returnOrder, reason, setReason }) {
        ...
        <Modal isOpen={isOpen} onClose={onClose} size="xl" scrollBehavior="inside">
            ...
            <ModalContent bg={bgCard} borderRadius="xl" mx={3}>
                ...
                <ModalFooter borderTopWidth="1px" borderColor={borderColor}>
                    ...
                    <Button ml={"8px"} colorScheme="red" isLoading={returning} loadingText="Saqlanmoqda..." onClick={returnOrder}>
                        Qaytarish
                    </Button>
                </ModalFooter>
            </ModalContent>
