                                ...
                                payment.invoices.length > 0 ? (
                                  <Tooltip
                                    label={payment.invoices
                                      .map(
                                        (inv) => inv.invNumber || inv.invoiceId,
                                      )
                                      .join(", ")}
                                    placement="top"
                                  >
      ...
      >
        ...
        <ModalContent>
          <form onSubmit={handleGeneralPayment}>
            <ModalHeader>
              {partner.name} klientdan to'lovni qabul qilish
            </ModalHeader>
            <ModalCloseButton />
            <ModalBody>
                  ...
                  <Card variant="outline">
                    <CardBody>
                      <VStack align="start" spacing={2}>
                        ...
                        <Badge
                          colorScheme={
                            PAYMENT_COLORS[selectedInvoice.paymentStatus]
                          }
                        >
                    ...
                    <VStack align="stretch" spacing={2}>
                      {detailCalculations?.hasDiscount && (
                        <Flex justify="space-between">
                          ...
                          <Text fontWeight="medium">
                            {formatNumber(detailCalculations?.subtotal || 0)}{" "}
                            so'm
                          </Text>
                        </Flex>
                      )}
                      ...
                      {detailCalculations?.hasDiscount && (
                        <Flex justify="space-between" color="orange.600">
                          <Text>Chegirma:</Text>
                          <Text fontWeight="medium">
                            -{formatNumber(detailCalculations.totalDiscount)}{" "}
                            so'm
                          </Text>
                        </Flex>
                      )}
                      {detailCalculations?.hasDiscount && <Divider />}
